    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Image.network(
          ...
          // IMAGE ERROR VERİRSE YERİNE YAZI YAZACAK.
        )
      ]),
    );
  }
...
class ImageItems {
  ...
  //SADECE PNG DOSYALARINI UZANTISIZ BURAYA YAZILACAK.
...
class PngImage extends StatelessWidget {
  ...
  final String name;
  //* BUNU EKLEDİĞİMİZDE REQUİRED UYARISI GELECEK. YUKARI REQUİRED EKLENECEK.
  ...
  //* name değişken olarak belirtildi.
  //* artık .png ibaresi kullanılmak zorunda değiliz.
